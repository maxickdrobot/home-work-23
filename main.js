...
document.write(`<p>Apple: ${calorieCalculator.getProductCalories("Apple")}</p>`);
document.write(`<p>Banana: ${calorieCalculator.getProductCalories("Banana")}</p>`);
...
document.write(`<p>Існує 'john_doe': ${uniqueUsernames.exists('john_doe')}</p>`);
document.write(`<p>Кількість унікальних імен: ${uniqueUsernames.count()}</p>`);
